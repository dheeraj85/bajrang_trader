(function($) {
    ...
    $.fn.btechco_excelexport = function(options) {
        ...
        function Export(htmltable) {
            ...
            var download='PurchaseItem_Report_'+formatted;
            var ctx = {worksheet: "Export" || "Worksheet", table: htmltable};
            //return uri + base64(format(excelFile, ctx,download))
            document.getElementById("dlink").href = uri + base64(format(excelFile, ctx));
            document.getElementById("dlink").download = download;
