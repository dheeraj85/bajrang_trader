...
(function($) {
    $.fn.lightBox = function(settings) {
        settings = jQuery.extend({overlayBgColor: '#000', overlayOpacity: 0.8, fixedNavigation: false, imageLoading: 'http://localhost:81/oms_app/front/images/lightbox-ico-loading.gif', imageBtnPrev: 'http://localhost:81/oms_app/front/images/lightbox-btn-prev.gif', imageBtnNext: 'http://localhost:81/oms_app/front/images/lightbox-btn-next.gif', imageBtnClose: 'http://localhost:81/oms_app/front/images/lightbox-btn-close.gif', imageBlank: 'http://localhost:81/oms_app/front/images/lightbox-blank.gif', containerBorderSize: 10, containerResizeSpeed: 400, txtImage: 'Image', txtOf: 'of', keyToClose: 'c', keyToPrev: 'p', keyToNext: 'n', imageArray: [], activeImage: 0}, settings);
