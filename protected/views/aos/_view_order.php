                                            ...
                                            <div class="col-lg-12">
                                               ...
                                               // if (!empty($list)) {
                                                    ...
                                                    <table class="table no-margin">
                                                        ...
                                                        //    $tax_amt = $net_amt * ($tax->tax_percent / 100);
                                                            $tax_amt = 0;
                                                                            ...
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-lg-3">
                                                                                    ...
                                                                                    <select name="design_complexity_id" id="design_complexity_id" onchange="getamt();" class="form-control" >
                                                                                        ...
                                                                                        <option value="<?php echo $design->id; ?>" <?php if($order->design_complexity_id==$design->id){ echo "selected"; }?>><?php echo $design->design_code; ?></option>                                                
                                                                                        <?php } ?>  
                                                                                    </select>
                                                                                </div>
                                                                                <div class="col-lg-4">
