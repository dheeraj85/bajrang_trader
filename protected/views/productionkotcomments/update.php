...
$this->menu=array(
    ...
    array('icon' => 'glyphicon glyphicon-list-alt','label'=>'View Productionkotcomments', 'url'=>array('view', 'id'=>$model->id)),
        ...
        <div class="col-lg-12">
            <div class="box">
                <div class="box-header btn-primary">
                    <h3 class="panel-title">Update Production KOT Comments</h3>
                </div>
