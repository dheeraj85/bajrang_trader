                       ...
                       if(!empty($model)){    
                        ...
                        if (!empty($ilist)) {
                            ...
                            $form = $this->beginWidget('bootstrap.widgets.BsActiveForm', array(
                                ...
                                'action' => $this->createUrl('outletindent/indentupdate'),
                            ));
                            ?>
                            ...
                            <a href="<?php echo $this->createUrl('outletindent/additemindent',array("id"=>$model->id)); ?>" class="btn btn-aqua">Add Item</a>
                            <input type="submit" name="updateindent" value="Save" class="btn btn-aqua" />         
                            <input type="submit" name="generateorder" value="Save & Generate Order" class="btn btn-aqua" />         
                            <?php $this->endWidget(); ?>
                 <?php }} ?>
                              </div><br/>
                </div>
