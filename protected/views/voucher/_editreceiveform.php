...
<div class="row"> 
    ...
    <div class="col-lg-4">
        <div id="receiver_name">
            ...
            <select class="form-control" name="Voucher[receiver_id]" id="Voucher_receiver_id">
                ...
                <?php
                foreach (Bankdetails::model()->findAll() as $bd) {
    ...
    <div class="col-lg-4">            
        <div id="other_name">
            <label>From</label><br/>
            <input name="Voucher[other_name]" id="Voucher_other_name" class="form-control" placeholder="From" type="text" value="<?php echo $model->other_name?>">
        </div>
    </div>
    <div class="col-lg-4">
