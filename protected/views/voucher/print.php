...
<div class="row">
    <div class="container">
        ...
        <div id="printorder" style="padding:10px;width:750px;background-color:#fff;"> 
            ...
            <br/>
            <?php
            $v_type = Vouchertype::model()->findByPk($model->voucher_type_id);
            ?>
            <table width="100%" class="format_table">
                <tr>
                    <?php if ($v_type->voucher_nature == 'debit') { ?>
                        <td style="border:1px solid #333;padding:5px;" width="15%"><b>Paid To :</b></td>                
                    <?php } else if ($v_type->voucher_nature == 'credit') { ?>
                        <td style="border:1px solid #333;padding:5px;" width="15%"><b>Paid By :</b></td>                
                    <?php } ?>
