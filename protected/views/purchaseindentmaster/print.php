...
$this->breadcrumbs = array(
    ...
    'Purchase Indent List' => array('purchaseindentmaster/admin'),
    'View Indent',
);
?>
<div class='form-css'>
        ...
        <div class="col-lg-12">      
            <div class="box">
                            ...
                            <table class='table table-bordered'>
                                ...
                                <tbody>
                                    ...
                                    foreach ($ilist as $v) {
                                        ?>
                                        <tr>
                                            <td width="40%"><?php echo $v->item_name; ?> (<?php echo $v->qty_scale; ?>)</td>
                                            <td width="20%"><?php echo $v->item_brand; ?></td>
                                            <td width="15%"><?php echo $v->qty_req; ?></td>
               ...
               <div style="display:none;" id="printorder">
                   ...
                   Prepared By <?php echo $model->createdby->name;?> &nbsp;&nbsp;&nbsp;&nbsp; Indent date : <?php echo $model->indend_date;?>
                 <?php
                       if(!empty($model)){    
                        $ilist = Purchaseindent::model()->findAllBySql("select * from purchase_indent where indent_id=$model->id order by id desc");   
                        //$list = Itemstock::model()->findAllByAttributes(array("p_category_id" => $model->p_category_id, "p_sub_category_id" => $model->p_sub_category_id));
                            ...
                            <table width="100%">
                                ...
                                <tbody>
                                    ...
                                    foreach ($ilist as $v) {
                                        ?>
                                        <tr>
                                            <td width="40%" style="border:1px solid #ddd;padding:5px;text-align: left;"><?php echo $v->item_name; ?> (<?php echo $v->qty_scale; ?>)</td>
                                            <td width="20%" style="border:1px solid #ddd;padding:5px;text-align: left;"><?php echo $v->item_brand; ?></td>
                                            <td width="15%" style="border:1px solid #ddd;padding:5px;text-align: left;"><?php echo $v->qty_req; ?></td>
