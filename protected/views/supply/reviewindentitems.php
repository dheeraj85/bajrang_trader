        ...
        <div class="col-lg-12">      
            <div class="box">
                <div class="box-header bg-yellow">
                    ...
                    <?php if ($model->is_order_done < 2) { ?>
                        <a href="#" onclick="getOrderDone('<?php echo $model->sync_id ?>')" class="btn btn-primary pull-right">Save & Finish</a>
                    <?php } ?>
                </div>
                                        ...
                                        <table class='table table-bordered table-responsive'>
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>Action</th>
                                                    <th>Qty Dispatch</th>      
                                                    <?php if ($model->is_indenting_done == 2) { ?>
                                                        <th>Qty Received</th>            
                                                    <?php } ?>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                ...
                                                foreach ($item_list as $v) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td> 
                                                            <a href='#' onclick="getStockOfItem('<?php echo $v->item_id; ?>', '<?php echo $v->id; ?>')" class="btn btn-primary">Dispatch</a>
                                                            <a href="#" onclick="viewDispatched('<?php echo $v->item_id; ?>', '<?php echo $v->id; ?>')" class="btn btn-info"><i class="glyphicon glyphicon-eye-open"></i> View</a>
                                                        </td>
                                                        <td> <?php echo $v->qty_dispatch; ?></td>

                                                        <?php if ($model->is_indenting_done == 2) { ?>
                                                            <td> <?php echo $v->qty_in_stock; ?></td>        
                                                        <?php } ?>
                                                    </tr>    
                                                    <?php
                                                    $c++;
...
<script type="text/javascript">
                                                    ...
                                                    function viewDispatched(item_id, id) {
                                                        var url = '<?php echo $this->createUrl("supply/getDispatchItem"); ?>';
