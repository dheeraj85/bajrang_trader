...
$this->breadcrumbs = array(
    ...
    'Consolidated Sales Bill Report',
);
...
<div class='form-css'>
    <div class="box box-primary">
        <div class="box-header with-border">
            <h3 class="panel-title">Consolidated Sales Bill Report</h3>
        </div>
                    ...
                    <?php if ($data['data']) { ?>
                            ...
                            foreach ($data['data'] as $order) { 
                                ...
                                <tr>
                                    ...
                                    <td class="text-left"><?php echo $order['txn_type']; ?></td>
                        ...
                        <?php } else { ?>
                            <tr>
                                <td class="text-center" colspan="5"><?php echo $data['text_no_results']; ?></td>
                            </tr>
                        <?php } ?>
                    </tbody>
                </table>
