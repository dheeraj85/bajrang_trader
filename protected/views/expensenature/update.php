...
$this->menu = array(
    ...
    array('icon' => 'glyphicon glyphicon-list-alt', 'label' => 'View Expensenature', 'url' => array('view', 'id' => $model->id)),
            ...
            <div class="col-lg-6">
                <div class="box">
                    <div class="box-header btn-primary">
                        <h3 class="panel-title">Update Expanse Nature</h3>
                    </div>
