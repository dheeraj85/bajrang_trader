...
<html>
    <head>
        ...
        ?>
        <link type="text/css" rel="stylesheet" href="<?php echo Yii::app()->request->baseUrl; ?>/bs/css/jquery.typeahead.css"/>
        <script src="<?php echo Yii::app()->request->baseUrl; ?>/front/libs/jquery/jquery-1.11.2.min.js"></script>
         <script src="<?php echo Yii::app()->request->baseUrl; ?>/bs/js/jquery.typeahead.js"></script>
        ...
        <div class="wrapper">
            ...
            <header class="main-header">
                ...
                <a href="<?php echo $this->createUrl('site/dashboard'); ?>" class="logo">
                    ...
                    <span class="logo-mini"><b>T</b>OC</span>
                    <!-- logo for regular state and mobile devices -->
                    <span class="logo-lg"><b>TOC - OMS</b> Panel</span>
                </a>
                    ...
                    <div class="navbar-custom-menu">
                        <ul class="nav navbar-nav">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li>
                                        ...
                                        <ul class="menu">
                                            <li>
                                                <a href="#">
                                                    <i class="fa fa-users text-aqua"></i> Next data backup scheduled at 8.00 PM
                                                </a>
                                            </li>
                                            <li>
                                                <a href="#">
                                                    <i class="fa fa-users text-red"></i> 5 New Member added today
                                                </a>
                                            </li>
                                        </ul>
                                    </li>
                            ...
                            <li class="dropdown user user-menu">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                    <img src="<?php echo Yii::app()->request->baseUrl; ?>/dist/img/toc-logo.jpg" class="user-image" alt="User Image">
                                    <?php
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="user-header">
                                        <img src="<?php echo Yii::app()->request->baseUrl; ?>/dist/img/toc-logo.jpg" class="img-circle" alt="User Image">
            ...
            <footer class="main-footer">
                ...
                <strong>Copyright &copy; 2015-2016 <a href="#">TOC Application</a>.</strong> All rights reserved.
            </footer>
