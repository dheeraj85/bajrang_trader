    ...
    <div class="col-lg-12">
        <div class="bg-lightgreen">
            <div class="row">
                ...
                <div class='col-lg-2'>
                    <label>Tax in %</label>     
                    <input name="tax_percent" id="tax_percent" class="form-control" placeholder="Tax %" type="text" readonly="readonly">
                </div>
            </div>
            <br/>    
            <div class="row"> 
                ...
                <div class='col-lg-2'>
                    ...
                    <input name="vendor_tax_percent" id="vendor_tax_percent" class="form-control" placeholder="Tax %" type="text">
                </div>
                <div class='col-lg-2'>
            ...
            <div class="row">               
                ...
                <div class='col-lg-3'>
                    ...
                    <input name="stock_qty" id="Purchaseinvoice_item_stock_qty" class="form-control" placeholder="Stock Qty" type="text"> 
            ...
            <div class="row"> 
                ...
                <div class='col-lg-2' style="display:none;" id="checkuttax">
                    <label>UT Tax (%)</label>     
                    <input name="ut_rate" id="Purchaseinvoice_ut_rate" class="form-control" placeholder="UT Tax (%)" type="text">
                </div>
                <div class='col-lg-2'>
                    <label>CESS Tax (%)</label>     
                    <input name="cess_rate" id="Purchaseinvoice_cess_rate" class="form-control" placeholder="CESS Tax (%)" type="text">
                </div>
            </div>
            <br/>
            ...
            <div class="pull-right" style="margin-top:12px;">
                ...
                <input type="button" class="btn savebtn btn-default" id="edititem" value="Edit Item" style="display:none;"/>
            </div>
...
<div class="row pull-right" style="margin-right:15px;">
  <input type="button" class="btn btn-warning" id="submit" value="Save & Send to Review"/>
</div>
<div style="clear:both"></div>
</div>
<?php $this->endWidget(); ?>
...
<?php } ?>
        ...
        $('#additem').click(function() {
            ...
            if ($("#item_id").val() == "") {
                ...
                confirm_boot('You have not provided Tax Percentage for this entry. If it attracts reverse charge then Click on "YES" else Click "NO" and proceed.', function(result) {
                //console.log("Confirmed? " + result);
                if (result) { 
                if($("#vendor_tax_percent").val()==""){
                ...
                $.ajax({
                    ...
                    data: form + '&YII_CSRF_TOKEN=<?php echo Yii::app()->request->csrfToken; ?>'+'&is_reverse_charge=1',
                    type: 'post',
                    cache: false,
                    success: function(response) {
    ...
    var confirm_boot = function(msg, callback) {
        bootbox.confirm({
            size: "large",
            title: '<i>Suri Graphics</i>',
            message: '<div style="font-size: 16px;" class="alert alert-danger">' + msg + '</div>',
            buttons: {
                cancel: {
