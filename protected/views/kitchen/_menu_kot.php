        ...
        <div class="col-sm-3" id="cart_items" style="height: 600px;overflow-y: scroll;">
            ...
            ?>
                    <button class="btn btn-warning status-btn" onclick="Viewkot(<?php echo $k->id; ?>);" style="margin-top: 5px;height: 50px;">
                        <strong style="float: left;">MKOT NO - <?php echo $k->kot_no; ?></strong>
...
<script type="text/javascript">
    ...
    function Viewkot(id) {
        $('#mkot_detail').html("<center><img src='<?php echo Yii::app()->baseUrl ?>/images/loader.gif'/></center>");
        $.ajax({
            url: '<?php echo $this->createUrl('kitchen/viewmenukot'); ?>',
            data: {'id': id},
            type: 'post',
            success: function(response) {
                $('#mkot_detail').html(response);
            }
        });
    }
</script>