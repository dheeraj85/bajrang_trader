...
if (!empty($sale)) {
    ...
    <div class="row">
        <div class="col-xs-12">
            <?php
            $items = Offshelfsaleitems::model()->findAllByAttributes(array('shelf_sale_id' => $sale->id), array('order' => 'id asc')); //print_r($items);     
            if (!empty($items)) {
                ?>
                <table class="table table-bordered">
                    ...
                    <tr>
                        <th colspan="17" style="text-align: center">PROFORMA</th>
                    </tr>
                    <tr>
                        <td colspan="7">
                            <table style="width: 100%">
                                ...
                                <tr>
                                    <td>Memo No</td>
                                    <td> <?php echo $sale->memo_number; ?></td>
                                </tr>
                                <tr>
                                    <td>Memo Date</td>
                    ...
                    <tr>
                        ...
                        <td colspan="10">
                            <?php if($sale->is_consignee_same=='Y') { ?>
                            <table style="width: 100%;border:0px">
                                <tr>
                                    <td style="font-size: 10px;font-weight: bold">Name:</td>
                                    <td style="font-size: 10px;font-weight: bold"><?php echo $customer->full_name; ?></td>
                                ...
                                <tr>
                                    <td style="font-size: 10px;font-weight: bold">GSTIN:</td>
                                    <td style="font-size: 10px;font-weight: bold"> <?php echo $customer->gstin_code; ?></td>
                                </tr>                                               
                            </table>
                            <?php }else { ?>
                                  <table style="width: 100%;border:0px">
                                ...
                                <tr>
                                    <td style="font-size: 10px;font-weight: bold">GSTIN:</td>
                                    <td style="font-size: 10px;font-weight: bold"> <?php echo $sale->consignee_gstin_no; ?></td>
                                </tr>                                               
                            </table>
                            <?php } ?>
                        </td>
