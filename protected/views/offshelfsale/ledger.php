...
<!--                        <div class='col-md-3'>
                            ...
                            <select id="Type_id" name="type" class="form-control required">
                                <option value="">-Select-</option>
                                <option value="sp_cust" <?php if($type=='sp_cust') echo "selected"; ?>>Special Customer</option>
                                <option value="in_trf" <?php if($type=='in_trf') echo "selected"; ?>>Internal Transfer</option>                                
                            </select>
                        </div>-->
                    ...
                    <?php if (!empty($list)) { ?>
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo $this->createUrl('customervoucher/create', array('id' => 11, 'receiver_type' => 'customer', 'receiver_id' => $list->id,'type'=>$type)) ?>" class="btn btn-green">Receive Payment</a>    
                                </td>
                            </tr>
                        </table>
                    <?php } ?>
    ...
    <div class='row'>
        <div class="col-lg-3">
            <div class="box">
                ...
                ?>
                <input type="hidden" id="customer_id" name="Customer[id]" value="<?php if (!empty($list)) { ?><?php
                    echo $list->id;
                }
                ?>"/>
                <input type="hidden" id="type" name="type" value="<?php if (!empty($type)) { ?><?php
                    echo $type;
                }
                ?>"/>
                <div class='col-md-12'>
...
<script type="text/javascript">
                                        ...
                                        function saveVoucherPayment(cid) {
                                            ...
                                            var vcr_amt =<?= isset($vc->amount)?$vc->amount:0; ?>;
                                            if (vcr_amt == '') {
