...
/**
 * This is the model class for table "cancel_shelf_items".
 *
 * The followings are the available columns in table 'cancel_shelf_items':
 * @property integer $id
 ...
 * @property CancelShelfSale $shelfSale
 */
class Cancelshelfitems extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return Cancelshelfitems the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			...
			array('qty, unit_price, discount_percent, amount', 'length', 'max'=>15),
			array('unit_tax', 'length', 'max'=>200),
	...
	public function relations()
	{
		...
		return array(
			'shelfSale' => array(self::BELONGS_TO, 'CancelShelfSale', 'shelf_sale_id'),
		);
	}
