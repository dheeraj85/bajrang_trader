...
class InvoicepayController extends Controller {
    ...
    public function actionIndex() {
        $dataProvider = new CActiveDataProvider('Invoicepay');
    ...
    public function loadModel($id) {
        $model = Invoicepay::model()->findByPk($id);
        if ($model === null)
     ...
     * @param Invoicepay $model the model to be validated
     */
    protected function performAjaxValidation($model) {
        if (isset($_POST['ajax']) && $_POST['ajax'] === 'invoicepay-form') {
