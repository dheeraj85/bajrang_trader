...
class TickettypeController extends Controller {
    ...
    public function actionUpdate($id) {
        ...
        if (isset($_POST['Tickettype'])) {
            $model->attributes = $_POST['Tickettype'];
            if ($model->save())
                d21('Ticket type updated by '.Yii::app()->user->getUsername(),"site.login");
    ...
    public function actionAdmin() {
        ...
        if (isset($_POST['Tickettype'])) {
            $model->attributes = $_POST['Tickettype'];
            if ($model->save())
                d21('Ticket type added by '.Yii::app()->user->getUsername(),"site.login");
                $this->redirect(array('admin'));
        }        
    ...
    protected function performAjaxValidation($model) {
        if (isset($_POST['ajax']) && $_POST['ajax'] === 'tickettype-form') {
